    ...
    internal class News_Command
    {
        ...
        public class News_command : BaseCommandModule
        {
...

            {
                ...
                if (_command_News.Channel.Id != ChannelId_News) //ONLY WANT TO SEND TO NEWS CHANNEL BECUASE DON'T SPAM OTHER GENERAL CHANNELS 
                {
                ...
                else
                {
                    ...
                    catch (Exception)
                    {
                        ...
                        /*Discord_logger_service.Log_Critical($"Request Failed{stack_trace}");*/ // stacktrace not neded here but can be used for debugging
        ...
        public class Marvel_rivals : BaseCommandModule
        {
            ...
            }
            {
                ...
                // This is a placeholder for the Marvel rivals command
